...
function Categories() {
	...
	// Function to add categories into an array in a nested format based on their parent category
	...
	// Function to add all of the categories into an array
	...
	// Displays modal for editing the categories
